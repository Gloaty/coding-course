function Common() {
    ...
    this.showNextPromotion = function () {
        ...
        $(self.promoBar.promoItems).fadeOut("slow").promise().done(function () {
            ...
            $(self.promoBar.promoItems).eq(self.romoBar.currentItem).fadeIn("slow", function () {
                /* Delay beofre showing next item */
                self.startDelay();
            });
        });
    }
